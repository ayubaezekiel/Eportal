...
import { BookOpen, CreditCard, FileText, Calendar, GraduationCap, Bell } from "lucide-react";
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">400L</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">Outstanding Fees</CardTitle>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              {quickActions.map((action) => (
                <Button key={action.title} variant="outline" className="h-20 flex-col">
