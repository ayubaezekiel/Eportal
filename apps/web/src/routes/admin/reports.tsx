...
function ReportsPage() {
  ...
  const approvedResults =
    results?.filter((r) => r.results.status === "Approved") || [];
  const averageGPA =
    approvedResults.length > 0
      ? (
          approvedResults.reduce(
            (sum, r) => sum + Number(r.results.gradePoint || 0),
            0
  ...
  const attendanceRate = ((presentAttendance / totalAttendance) * 100).toFixed(
    1
  );
    ...
    switch (type) {
      ...
      case "financial":
        data = {
          payments: confirmedPayments,
          totalRevenue,
          summary: { totalPayments: confirmedPayments.length, totalRevenue },
        };
      ...
      case "academic":
        data = {
          results: approvedResults,
          averageGPA,
          summary: { totalResults: approvedResults.length, averageGPA },
        };
  ...
  const reportTypes = [
    ...
    },
    {
      ...
      description: "Results and grade analysis",
      icon: BarChart3,
    },
    {
      id: "attendance",
